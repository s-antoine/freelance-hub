  ...
  <div class="p-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
      <div class="bg-white rounded-2xl border border-gray-200 p-6">
        <p class="text-sm text-gray-500 mb-2">Revenus (factures payées)</p>
      ...
      <div class="bg-white rounded-2xl border border-gray-200 p-6">
        <p class="text-sm text-gray-500 mb-2">Bénéfice net</p>
        <p class="text-3xl font-bold" :class="profit >= 0 ? 'text-indigo-600' : 'text-red-600'">
